    ...
    var app = {
        ...
        newTranslation: function () {
            ...
            $('select[name="catalog"]').on('change', function () {
                ...
                if (catalog !== '') {
                    var url = app.urls.categoryDropdown + '?catalog=' + catalog + '&itemType=' + itemType;
        ...
        followup: {
            ...
            populateMoreData: function (documents) {
                ...
                documents.forEach(function (document) {
                    var docTitle = document.project_name + document.project_launch_date;
                    var createdAt = document.created_at.full;
                    ...
                    var docDate = datePart + ' ' + hour + ':' + minute;
                    var itemID = document.custom_data.item && document.custom_data.item.id ? document.custom_data.item.id : '';
                    var itemName = document.custom_data && document.custom_data.item && document.custom_data.item.name ? document.custom_data.item.name : '';
                    var itemType = document.item_type ? document.item_type : '';
                    var docLocale = document.locale;
                    ...
                    if (docStatus) {
                        switch (docStatus.toLowerCase()) { // eslint-disable-line default-case
                        case 'in_creation':
            ...
            populateStatusDiagram: function () {
                ...
                var total = statusObj.creation + statusObj.progress + statusObj.review + statusObj.completed;
